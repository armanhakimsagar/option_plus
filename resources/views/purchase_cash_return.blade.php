...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-8">
                    @if(session()->has('purchase_cash_return'))
                    ...
                    @endif
                        <div class="card text-dark">
                            <div class="card-header">
                                Purchase Cash Return
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form role="form" action="purchaseCashInsert" method="post">
                                        {{ csrf_field() }}
                                            ...
                                            <button type="submit" class="btn btn-success">Add Purchase Cash Return</button>
                                        </form>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
                                </div>
